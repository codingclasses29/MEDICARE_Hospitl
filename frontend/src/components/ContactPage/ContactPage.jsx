...
export default function ContactPage() {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/7323966221?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> 7323966221
            </p>
            <p className={contactPageStyles.infoItem}>
              <Mail size={16} /> codingclasses29@gmail.com
            </p>
          </div>

          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7162.249603116389!2d84.52316654247178!3d26.16006468828231!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3992e670c4db6a71%3A0xbbdd9d6b6303370f!2sRatanpura%2C%20Bihar!5e0!3m2!1sen!2sin!4v1771143125299!5m2!1sen!2sin"
            className={contactPageStyles.map}
            title="Ratnpura Siwan Bihar Map"
            loading="lazy"
            allowFullScreen
          ></iframe>
